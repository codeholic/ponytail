require './application'
Ponytail::Application.initialize!

# Development middlewares
if Ponytail::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => Ponytail::Application.root(:public)
end
...
#
run Ponytail::Application.routes
